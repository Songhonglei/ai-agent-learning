...
export function LocalProgressSync({ onMerge, onKeepCloud }: LocalProgressSyncProps) {
  return (
    <section className="account-gate local-progress-sync" role="dialog" aria-labelledby="local-progress-sync-title">
      ...
      <div className="status-actions local-progress-sync-actions">
